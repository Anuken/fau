...
proc `or`*(f1, f2: ImguiWindowFlags): ImguiWindowFlags = ((f1.int32) or (f2.int32)).ImguiWindowFlags
proc `or`*(f1, f2: ImGuiColorEditFlags): ImGuiColorEditFlags = ((f1.int32) or (f2.int32)).ImGuiColorEditFlags
...
proc imguiInitFau*(useCursor = true, theme: proc() = nil, font: static string = "", fontSize = 22f) =
  ...
  addFauListener do(e: FauEvent):
    ...
    of feText:
      io.addInputCharactersUTF8(e.text.cstring)
    of feTouch:
